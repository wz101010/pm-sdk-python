...
class TestAuthorizePolicy(unittest.TestCase):
    """AuthorizePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthorizePolicy:
        """Test AuthorizePolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthorizePolicy`
        """
        model = AuthorizePolicy()
        if include_optional:
